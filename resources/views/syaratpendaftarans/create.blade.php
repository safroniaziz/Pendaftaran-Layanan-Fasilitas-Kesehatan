        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                <div class="row">
                    ...
                    <form action="{{ route('syaratpendaftarans.post') }}" enctype="multipart/form-data" method="POST" enctype="multipart/form-data">
                        {{ csrf_field() }} {{ method_field('POST') }}
                        <div class="form-group col-md-12">
                            <label for="exampleInputEmail1">Masukan Syarat Pendaftaran</label>
                            <input type="text" name="syarat_pendaftaran" class="form-control" >
                            <div>
