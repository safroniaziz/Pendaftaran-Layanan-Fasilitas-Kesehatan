        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                <div class="row">
                    ...
                    <form action="{{ route('mitras.post') }}" enctype="multipart/form-data" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <input type="date" name="tanggal_kerja_sama" class="form-control" >
                            <div>
