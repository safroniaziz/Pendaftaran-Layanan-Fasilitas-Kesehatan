...
<html lang="id" style="" class="js no-touch history boxshadow csstransforms3d csstransitions video svg webkit chrome win js sticky-header-enabled sticky-header-negative sticky-header-active">
  <head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
		...
		<title>Pendaftaran Vaksinasi Meningitis RS UNS</title>	
	...
	<body>
		<div class="body">
			<div role="main" class="main">
							...
							<div class="col-md-6 animate__animated animate__fadeInLeft">
								<div class="row">
									<form action="{{ route('daftar') }}" method="POST" style="margin-top: 15px !important;">
										...
										<div class="form-group col-md-12">
											<label for="">Umur <a class="text-danger">*</a></label>
										...
										<div class="form-group col-md-12">
											...
											<textarea name="keluhan" class="form-control" id="" cols="30" rows="3"></textarea>
											<div>
				...
				<footer class="footer mt-auto py-3" style="background-color: #f4f4f4;">
					<div class="row">
						<div class="col-md-12">
